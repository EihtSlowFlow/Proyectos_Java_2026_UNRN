...
public class Principal {
    static void main() {
        Notificador noti = new EmailService();
        ...
        Concurso concurso = new Concurso(fec_inscripcion, fec_inscripcion.plusDays(5), "Art Renewal Center (ARC) Salon Competition (EE.UU.)", exportador, noti, () -> LocalDate.now());
