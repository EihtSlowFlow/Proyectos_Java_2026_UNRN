...
import ar.unrn.tp4_1.ejercicio1.EmpleadoInterface;
import ar.unrn.tp4_1.ejercicio1.EmpleadoRegular;
import ar.unrn.tp4_1.ejercicio1.EmpleadoConGenteACargo;
...
public class TestEmpresa {
    ...
    public void testCalcularSueldoSubordinadosParcial() {
        ...
        EmpleadoInterface gerente = new EmpleadoConGenteACargo(3000, List.of(empleado1, empleado2), ar.unrn.tp4_1.ejercicio1.ROL.GERENTE);
    ...
    public void testCalcularSueldoEmpleados() {
        ...
        EmpleadoInterface liderProyecto = new EmpleadoConGenteACargo(3000, List.of(empleado1, empleado2), ar.unrn.tp4_1.ejercicio1.ROL.LIDER_PROYECTO);

        // Mando medio con lideres de proyecto
        EmpleadoInterface mandoMedio = new EmpleadoConGenteACargo(4000, List.of(liderProyecto), ar.unrn.tp4_1.ejercicio1.ROL.MANDO_MEDIO);

        // Gerente con mandos medios
        EmpleadoInterface gerente = new EmpleadoConGenteACargo(5000, List.of(mandoMedio), ar.unrn.tp4_1.ejercicio1.ROL.GERENTE);

        // Director con gerentes
        EmpleadoInterface director = new EmpleadoConGenteACargo(6000, List.of(gerente), ar.unrn.tp4_1.ejercicio1.ROL.DIRECTOR);
